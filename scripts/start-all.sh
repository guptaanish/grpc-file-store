#!/usr/bin/env bash
# Build and start the full stack (backend + frontend + envoy) via Docker Compose
set -e
...
echo "║  gRPC API Docs:        http://localhost:8080/grpc-docs.html      ║"
